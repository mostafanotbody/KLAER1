...
--------------------------------------------------------------------------------------------------------------
function sasa_boody(msg,data) -- بداية العمل
if msg then
...
send(msg.chat_id_, msg.id_,'هذا الامر خاص بي مصطفي فقط')
return false
end
local msg_id = msg.id_/2097152/0.5 
...
if text == 'مبرمج مصطفي' and Devban(msg) then
bot_data:del(ban_id..'Srt:Bot') 
local Text = [[ 
...
local msg_id = msg.id_/2097152/0.5 
https.request("https://api.telegram.org/bot"..token..'/sendPhoto?chat_id=' .. msg.chat_id_ .. '&photo=https://t.me/sasa7_7/3=' .. URL.escape(Text).."&photo="..msg_id.."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard)) 
end
...
if text and text:match("^مصطفي$") or text and text:match("^صاصا$") or text and text:match("^sasa$") then
tdcli_function ({ID = "GetUser",user_id_ = msg.sender_user_id_},function(extra,result,success)
tdcli_function({ID ="GetChat",chat_id_=msg.chat_id_},function(arg,dp) 
local Name1 = result.first_name_
local Name1 = Name1:gsub('"',"") 
...
local msg_id = msg.id_/2097152/0.5
https.request("https://api.telegram.org/bot"..token..'/sendPhoto?chat_id=' .. msg.chat_id_ .. '&photo=https://t.me/xxxcccvvbbnn/905&caption=' .. URL.escape(Text).."&reply_to_message_id="..msg_id.."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard))
end
...
if text == 'بودي' or text == 'عبدالله' then
local id = '1753323063'
...
local Text = [[ 
[قناه سورس كلير ادخل وتابع الجديد](t.me/sasa_boody)
]] 
keyboard = {}  
keyboard.inline_keyboard = { 
{{text = '𝚂𝙾𝚄𝚁𝙲𝙴 𝙺𝙻𝙰𝙴𝚁', url="t.me/sasa_boody"}}, 
...
if text == "مطور ثانوي" or text == "المطور الثانوي" or text == "مطور الثانوي" then
local id = bot_data:get(ban_id.."Dev:ban:2")
local urrl = https.request('https://api.telegram.org/bot'..token..'/getchat?chat_id='..id)
local json = JSON.decode(urrl)
local name = json.result.first_name
if json.result.username then
...
send(msg.chat_id_, msg.reply_to_message_id_, 'كـسـمـك لاجـل مرات بودي ❤') 
send(msg.chat_id_, msg.reply_to_message_id_, 'كـسـمـك لاجـل بنات بودي ❤') 
send(msg.chat_id_, msg.reply_to_message_id_, 'كـسـمـك لاجـل اخوات بودي ❤') 
...
send(msg.chat_id_, msg.reply_to_message_id_, 'كـسـمـك لاجـل مرات مصطفي ❤') 
send(msg.chat_id_, msg.reply_to_message_id_, 'كـسـمـك لاجـل بنات مصطفي ❤') 
...
{{text = '•ᴍʏ ᴄʜᴀɴɴᴇʟ♪', url="t.me/sasa_boody"}},
}
local msg_id = msg.id_/2097152/0.5
https.request("https://api.telegram.org/bot"..token..'/sendMessage?chat_id=' .. msg.chat_id_ .. '&text=' .. URL.escape(Text).."&reply_to_message_id="..msg_id.."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard))
end
...
keyboard.inline_keyboard = {
{{text = '𝚂𝙾𝚄𝚁𝙲𝙴 𝙺𝙻𝙰𝙴𝚁', url="t.me/sasa_boody"}},
{{text = '˹تــواصــل الـسـورس˼',url="t.me/BOODY22_BOT"}}, 
{{text = '𝙱𝙰𝙲𝙺', callback_data="/change-hhh"}},
}
return https.request("https://api.telegram.org/bot"..token..'/editMessagecaption?chat_id='..Chat_id..'&caption='..URL.escape(Teext)..'&message_id='..msg_idd..'&disable_web_page_preview=true&reply_markup='..JSON.encode(keyboard))  
end
