...
if DRAGON1_Msg then 
tdcli_function ({ID = "GetUser",user_id_ = msg.sender_user_id_},function(arg,data) 
send(msg.chat_id_, msg.id_,' ❤ الـعـضو   ⇦↯[↝'..Rutba(msg.sender_user_id_,msg.chat_id_)..'↜](T.ME/'..(data.username_ or 'sasa_boody')..') \n ❤ '..DRAGON1_Msg)
DeleteMessage(msg.chat_id_, {[0] = msg.id_})     
return false
end,nil)
end
...
local Text = [[
مطورين ومبرمجين سورس هوجان اتبع الازرار للتواصل معهم ⬇️🧿
]]
keyboard = {} 
keyboard.inline_keyboard = {
...
tdcli_function ({ID = "GetUser",user_id_ = msg.sender_user_id_},function(arg,data) 
send(msg.chat_id_, msg.id_,' ❤ تم تعطيل جلب الصوره ،\n ❤ تم قفل البوتات  ،\n ❤ تم قفل التكرار ،\n ❤ تم قفل الروابط ،\n ❤ تم قفل التوجيه ،\n ❤ تم قفل الملصقات ،\n ❤ تم قفل المتحركه ،\n ❤ تم قفل الفيديو ،\n ❤ تم قفل الفشار ،\n ❤ تم قفل الانلاين ،\n ❤ تم قفل تعديل المديا ،\n ❤ تم وضع التكرار  ،\n ❤ تم قفل الفارسيه  ،\n ❤ تم وضع الايدي بدون صوره ،n  \n ❤ تم تفعيل الحمايه  بواسطه ، [↝'..Rutba(msg.sender_user_id_,msg.chat_id_)..'↜](T.ME/'..(data.username_ or 'sasa_boody')..')  ')
end,nil)   
end
...
tdcli_function ({ID = "GetUser",user_id_ = msg.sender_user_id_},function(arg,data) 
send(msg.chat_id_, msg.id_,'  تم تعطيل الحمايه القصوه من قبل    [↝'..Rutba(msg.sender_user_id_,msg.chat_id_)..'↜](T.ME/'..(data.username_ or 'sasa_boody')..')  ')
end,nil)   
end
if text == 'قفل الدردشه' and msg.reply_to_message_id_ == 0 and Manager(msg) then 
database:set(bot_id.."lock:text"..msg.chat_id_,true) 
tdcli_function ({ID = "GetUser",user_id_ = msg.sender_user_id_},function(arg,data)  
send(msg.chat_id_, msg.id_,' ❤  مـن قبـل  ⇦↯[↝'..Rutba(msg.sender_user_id_,msg.chat_id_)..'↜](T.ME/'..(data.username_ or 'sasa_boody')..') \n ❤ تـم قفـل الدردشه ')
end,nil)   
...
tdcli_function ({ID = "GetUser",user_id_ = msg.sender_user_id_},function(arg,data) 
send(msg.chat_id_, msg.id_,' ❤  مـن قبـل  ⇦↯['..string.sub(data.first_name_,0,60)..'](T.ME/'..(data.username_ or 'sasa_boody')..') \n ❤ تـم قفـل التاك بالكتم ')
end,nil)   
...
if blakrt == 'مميز' and Mod(msg) then
send(msg.chat_id_, msg.id_,'\n ❤ الـعـضو   ⇦↯['..result.title_..'](t.me/'..(text1[3] or 'sasa_boody')..')'..'\n ❤ تم رفعه '..text1[2]..'')   
database:sadd(bot_id..'Special:User'..msg.chat_id_,result.id_)  
...
keyboard = {} 
keyboard.inline_keyboard = {
{{text = '《𝚂𝙾𝚄𝚁𝙲?? 𝙷𝙾𝙶𝙰𝙽》', url="t.me/sasa_boody"}},
}
local msg_id = msg.id_/2097152/0.5
