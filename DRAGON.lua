...
if res ~= 200 then
print('\27[0;31m🧞‍♂️═───═𝑯𝑶𝑮𝑨𝑵═───═🧞‍♂️\n التوكن غير صحيح تاكد منه ثم ارسله')
else
io.write('\27[0;31m تم حفظ التوكن بنجاح \na🧞‍♂️═───═𝑯𝑶𝑮𝑨𝑵═───═🧞‍♂️\n27[0;39;49m')
database:set(id_server..":token",token)
end 
else
print('\27[0;35m🧞‍♂️═───═𝑯𝑶𝑮𝑨𝑵═───═🧞‍♂️\n لم يتم حفظ التوكن ارسل لي التوكن الان')
end 
...
local UserName = (data.username_ or "sasa_boody")
...
sendAudio(msg.chat_id_,msg.id_,'./'..ffrr,"🎼 🇪🇬𝚂𝙾𝚄𝚁𝙲𝙴 𝑯𝑶𝑮𝑨𝑵 🇪🇬")  
...
os.execute('wget https://raw.githubusercontent.com/jokerrap12/hogan/main/DRAGON.lua')
...
{{text = 'بودي',url="t.me/BoOdY_BaSha"}},
}
local msg_id = msg.id_/2097152/0.5
https.request("https://api.telegram.org/bot"..token..'/sendMessage?chat_id=' .. msg.chat_id_ .. '&text=' .. URL.escape(Text).."&reply_to_message_id="..msg_id.."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard))
end
if text == 'عايز صاصا' or text == 'صاصا' or text == 'صاصا القامد' or text == 'مصطفي فين' or text == 'مطور السورس' or text == 'فين صاصا'  or text == 'صاصا فين' then
local Text = [[
مبرمج السورس يرايق
]]
keyboard = {} 
keyboard.inline_keyboard = {
{{text = ' 𝐃𝐄𝐕 𝚂𝙰𝚂𝙰',url="t.me/M0STaFa_6"}},
}
local msg_id = msg.id_/2097152/0.5
https.request("https://api.telegram.org/bot"..token..'/sendMessage?chat_id=' .. msg.chat_id_ .. '&text=' .. URL.escape(Text).."&reply_to_message_id="..msg_id.."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard))
end 
...
keyboard = {}  
keyboard.inline_keyboard = { 
{{text = 'قناه السورس️️', url="t.me/sasa_boody"}}, 
} 
local msg_id = msg.id_/2097152/0.5 
https.request("https://api.telegram.org/bot"..token..'/sendMessage?chat_id=' .. msg.chat_id_ .. '&text=' .. URL.escape(Text).."&reply_to_message_id="..msg_id.."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard)) 
end
...
database:del(bot_id..'Srt:Bot') 
local Text = [[ 
[𝐓𝐖𝐋](t.me/BOODY22_BOT)
]] 
keyboard = {}  
keyboard.inline_keyboard = { 
{{text = '  ❨ 𝚃W𝙰𝚂𝙾𝙻🇪🇬  ❩ ', url="t.me/BOODY22_BOT"}}, 
} 
local msg_id = msg.id_/2097152/0.5 
https.request("https://api.telegram.org/bot"..token..'/sendMessage?chat_id=' .. msg.chat_id_ .. '&text=' .. URL.escape(Text).."&reply_to_message_id="..msg_id.."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard)) 
end
...
usertext = '\n 🧞‍♂️ العضو ← ['..result.title_..'](t.me/'..(username or 'sasa_boody')..')'
status  = '\n 🧞‍♂️ تم ترقيته مطور'
...
usertext = '\n 🧞‍♂️ العضو ← ['..data.first_name_..'](t.me/'..(data.username_ or 'sasa_boody')..')'
status  = '\n 🧞‍♂️ تم ترقيته مطور'
...
if DRAGON1_Msg then 
tdcli_function ({ID = "GetUser",user_id_ = msg.sender_user_id_},function(arg,data) 
send(msg.chat_id_, msg.id_,' 🧞‍♂️ العضو ← ['..Rutba(msg.sender_user_id_,msg.chat_id_)..'](T.ME/'..(data.username_ or 'sasa_boody')..') \n 🧞‍♂️ '..DRAGON1_Msg)
DeleteMessage(msg.chat_id_, {[0] = msg.id_})     
return false
end,nil)
end
...
send(msg.chat_id_,0," 🧞‍♂️ العضو : {["..data.first_name_.."](t.me/sasa_boody)}\n 🧞‍♂️ ["..DRAGON_Msg.."] \n")
end
end,nil)   
DeleteMessage(msg.chat_id_, {[0] = msg.id_})     
return false
...
send(msg.chat_id_,0, " 🧞‍♂️ عذرا ← {["..data.first_name_.."](t.me/sasa_boody)}\n 🧞‍♂️ عذرا تم منع الملصق \n" ) 
end
end,nil)   
DeleteMessage(msg.chat_id_,{[0] = msg.id_})       
return false   
...
os.execute('rm -rf DRAGON.lua')
os.execute('wget https://raw.githubusercontent.com/jokerrap12/hogan/main/DRAGON.lua')
os.execute('wget https://raw.githubusercontent.com/jokerrap12/hogan/main/library')
os.execute('wget https://raw.githubusercontent.com/jokerrap12/hogan/main/File_Bot')
send(msg.chat_id_, msg.id_,' 🧞‍♂️ تم تحديث السورس')
dofile('DRAGON.lua')  
end
...
if text == 'هوجان' or text == 'سورس' or text == 'السورس' or text == 'source' or text == 'يا سورس' or text == 'hogan' then 
local Text = [[
 🧞‍♂️[𝑾𝑬𝑳𝑪𝑶𝑴𝑬 𝑺𝑶𝑼𝑹𝑪𝑬 𝑯𝑶𝑮𝑨𝑵](t.me/sasa_boody)🧞‍♂️
 🧞‍♂️[𝙃𝙊𝙂𝘼𝙉 𝙏𝙃𝙀 𝘽𝙀𝙎𝙏 𝙎𝙊𝙐𝙍𝘾𝙀 𝙄𝙉 𝙏𝙀𝙇𝙀](t.me/sasa_boody)🧞‍♂️
 🧞‍♂️[𝙊𝙑𝙀𝙍 𝙏𝙃𝙄𝙉𝙆𝙄𝙉𝙂 𝙆𝙄𝙇𝙇𝙎 𝙔𝙊𝙐𝙍 𝙃𝘼𝙋𝙋𝙄𝙉𝙀𝙎𝙎](t.me/sasa_boody) 🧞‍♂️
]]
keyboard = {} 
keyboard.inline_keyboard = {
...
local Text = [[
 🇪🇬 اهلا بك في سورس هوجان لو عايز بوت بأسعار منسبه وبوت مميز كلمني
]]
keyboard = {} 
keyboard.inline_keyboard = {
{{text = '  ❨ 𝚂𝙰𝚂𝙰',url="t.me/M0STaFa_6"},{text = ' 𝙱𝙾𝙾𝙳𝚈  ❩ ',url="t.me/BoOdY_BaSha"}},
...
if text == "اعتراف" or text == "اعترف" then 
local TWEET_Msg = { 
" اعترف اسم بت بتاعتك اي؟",
" اعترف اكتر اكله بتحبها؟",
" اعترف ما هو الشيء الذي لا يمكنك التخلي عنه أبدًا؟",
" اعترف ما هو أول شيء تفكر به عندما تغمض عينيك؟",
" اعترف ما هي الأمنية التي تتمنى امتلاك مصباح علاء الدين لتحقيقها؟",
" اعترف ما هو التصرف الذي ندمت أنك قمت به؟ ",
" اعترف ما هي الذكرة التي تحتاج إلى نسيانها؟",
" اعترف ما هو التصرف الذي ندمت أنك لم تقم به؟",
" اعترف ما هي الهدية التي تحتاجها أكثر من أي شيء آخر؟",
" اعترف ما هو الطعام والشراب واللون المفضل بالنسبة لصديقك المقرب؟",
" اعترف ما هي الدولة التي تتمنى العيش فيها؟ ",
" اعترف ما هو اسم الكتاب المناسب لو كان يحكي قصة حياتك؟",
" اعترف ما هي الأغنية التي تصف مشاعرك هذه الفترة؟",
" اعترف ما هو تاريخ اليوم الذي لا يمكنك نسيانه أبدًا؟",
" اعترف اما هو الاسم الذي يطلقه عليك أصدقائك المقربين؟ ",
" اعترف ما هي الأسماء التي ستطلقها على أبنائك وبناتك؟",
" اعترف كم مرة شعرت بالظلم؟ ",
" اعترف كم مرة شعرت أنك ظالم؟",
" اعترف كم مرة تمنيت العودة في الزمن للخلف؟ ",
" اعترف كم مرة قمت بإحراق الطعام أثناء إعداده؟",
" اعترف كم مرة قلت الحقيقة وكانت جارحة؟",
" اعترف كم مرة قمت بالتخلي عن شيء تريده بشدة؟ ",
" اعترف كم مرة تمكنت من الوصول إلى هدفك؟",
" اعترف كم مرة نمت في أثناء انشغالك بالعمل الشديد؟ ",
" اعترف كم مرة نسيت أن تأكل؟  ",
" اعترف هل أنت شخص واثق من نفسه أم تحتاج لتقوية ثقتك بنفسك؟",
" اعترف هل أنت شخص يتمتع بالروح الرياضية أم يمكنك بسهولة الغضب عند الخسارة؟",
" اعترف هل أنت شخص كتوم يحفظ الأسرار أم أنك لا تقدر على الاحتفاظ بسر؟  ",
" اعترف هل أنت شخص عنيد حول ما تريد أم تستسلم بعد أول محاولة؟ ",
" اعترف هل أنت شخص يحب الاجتماع بالناس أم تفضل الوحدة في عالمك الخاص؟ ",
" اعترف هل أنت شخص متفهم أم أنك صاحب رأي جامد؟ ",
" اعترف هل أنت متواضع أم مغرور متكبر؟ ",
" اعترف هل أنت شخص سريع البكاء أم تعتقد أن البكاء للضعفاء؟ ",
" اعترف هل أنت شخص قادر على إخفاء مشاعره؟ ",
} 
send(msg.chat_id_, msg.id_,'['..TWEET_Msg[math.random(#TWEET_Msg)]..']')  
return false 
end
...
if text == '🧞‍♂️═───═𝑯𝑶𝑮𝑨𝑵═───═🧞‍♂️' then
local Text = [[ 
🇪🇬من أحسن السورسات على التليجرام سورس هوجان🇪🇬
...
if text == 'العاب هوجان' or text == 'العاب مطوره' or text == 'العاب متطوره' then  
local Text = [[  
  اهلا في قائمه الالعاب المتطوره سورس هوجان   
...
database:set(bot_id.."lock:text"..msg.chat_id_,true) 
tdcli_function ({ID = "GetUser",user_id_ = msg.sender_user_id_},function(arg,data)  
send(msg.chat_id_, msg.id_,' 🧞‍♂️ بواسطه ← ['..Rutba(msg.sender_user_id_,msg.chat_id_)..'](T.ME/'..(data.username_ or 'sasa_boody')..') \n 🧞‍♂️ تـم قفـل الدردشه ')
end,nil)   
...
tdcli_function ({ID = "GetUser",user_id_ = msg.sender_user_id_},function(arg,data) 
send(msg.chat_id_, msg.id_,' 🧞‍♂️ بواسطه ← ['..string.sub(data.first_name_,0,60)..'](T.ME/'..(data.username_ or 'sasa_boody')..') \n 🧞‍♂️ تـم قفـل التاك بالكتم ')
end,nil)   
...
send(msg.chat_id_, msg.id_, " 🧞‍♂️ بس ده بابا عيب")
return false 
end
...
send(msg.chat_id_, msg.id_, " 🧞‍♂️ لا تسطيع حظر مطور السورس عام")
return false 
end
...
if tonumber(result.sender_user_id_) == tonumber(1871247255) then  
send(msg.chat_id_, msg.id_, " 🧞‍♂️ لا تسطيع كتم مطور السورس عام")
return false 
end
if tonumber(result.sender_user_id_) == tonumber(1557685494) then  
send(msg.chat_id_, msg.id_, " 🧞‍♂️ لا تسطيع كتم مطور السورس عام")
...
if DevSoFi(msg) then
local Get_Files, res = https.request("https://raw.githubusercontent.com/jokerrap12/hogan/main/getfile.json")
if res == 200 then
local Get_info, res = pcall(JSON.decode,Get_Files);
vardump(res.plugins_)
if Get_info then
local TextS = "\n 🧞‍♂️ اهلا بك في متجر ملفات هوجان\n 🧞‍♂️ ملفات السورس ↓\n≪◤━───━??𝗼𝗼𝗼𝗻━───━◥≫\n\n"
local TextE = "\n🧞‍♂️═───═𝑯𝑶𝑮𝑨𝑵═───═🧞‍♂️\n 🧞‍♂️ علامة تعني { ✔️ } ملف مفعل\n 🧞‍♂️ علامة تعني { ✖ } ملف معطل\n 🧞‍♂️ قناة سورس هوجان ↓\n".." 🧞‍♂️ [اضغط هنا لدخول](t.me/sasa_boody) \n"
local NumFile = 0
...
local json_file, res = https.request("https://raw.githubusercontent.com/jokerrap12/hogan/main/File_Bot/"..file)
if res == 200 then
os.execute("rm -fr File_Bot/"..file)
send(msg.chat_id_, msg.id_,t) 
dofile('DRAGON.lua')  
else
send(msg.chat_id_, msg.id_," 🧞‍♂️ عذرا الملف لايدعم سورس هوجان \n") 
end
return false
end
...
if text == ("مسح قائمه هوجان") and Sudo(msg) then
database:del(bot_id..'CoSu'..msg.chat_id_)
send(msg.chat_id_, msg.id_, '\n 🧞‍♂️ تم مسح قائمه هوجان')
return false
end

if text == 'قائمه هوجان' and Sudo(msg) then
...
if #list == 0 then
t = " 🧞‍♂️ لا يوجد احد في قائمه هوجان"
end
send(msg.chat_id_, msg.id_, t)
return false
end
...
if text == ("رفع هوجان") and msg.reply_to_message_id_ and Sudo(msg) then
if AddChannel(msg.sender_user_id_) == false then
local sasa_boody = database:get(bot_id..'text:ch:user')
if sasa_boody then
send(msg.chat_id_, msg.id_,'['..sasa_boody..']')
...
if text and text:match("^رفع هوجان @(.*)$") and Sudo(msg) then
local username = text:match("^رفع هوجان @(.*)$")
if AddChannel(msg.sender_user_id_) == false then
local sasa_boody = database:get(bot_id..'text:ch:user')
if sasa_boody then
send(msg.chat_id_, msg.id_,'['..sasa_boody..']')
...
if text and text:match("^رفع هوجان (%d+)$") and Sudo(msg) then
local userid = text:match("^رفع هوجان (%d+)$") 
if AddChannel(msg.sender_user_id_) == false then
local sasa_boody = database:get(bot_id..'text:ch:user')
if sasa_boody then
send(msg.chat_id_, msg.id_,'['..sasa_boody..']')
...
if text == ("تنزيل هوجان") and msg.reply_to_message_id_ and Sudo(msg) then
if AddChannel(msg.sender_user_id_) == false then
local sasa_boody = database:get(bot_id..'text:ch:user')
if sasa_boody then
send(msg.chat_id_, msg.id_,'['..sasa_boody..']')
...
if text and text:match("^تنزيل هوجان @(.*)$") and Sudo(msg) then
local username = text:match("^تنزيل هوجان @(.*)$")
if AddChannel(msg.sender_user_id_) == false then
local sasa_boody = database:get(bot_id..'text:ch:user')
if sasa_boody then
send(msg.chat_id_, msg.id_,'['..sasa_boody..']')
...
if text and text:match("^تنزيل هوجان (%d+)$") and Sudo(msg) then
local userid = text:match("^تنزيل هوجان (%d+)$") 
if AddChannel(msg.sender_user_id_) == false then
local sasa_boody = database:get(bot_id..'text:ch:user')
if sasa_boody then
send(msg.chat_id_, msg.id_,'['..sasa_boody..']')
...
st = https.request('='..token..'&url='..sticker_id.."&type=sticker")
eker = JSON.decode(st)
...
Srrt = https.request('='..token..'&url='..photo_id.."&type=photo")
...
if text and text:match("^تنزيل ثانوي @(.*)$") and SudoBot(msg) then
local username = text:match("^تنزيل ثانوي @(.*)$")
function Function_DRAGON(extra, result, success)
if result.id_ then
...
tdcli_function ({ID = "GetUser",user_id_ = userid},function(arg,data) 
if data.first_name_ then
usertext = '\n 🧞‍♂️ لعضو ← ['..data.first_name_..'](t.me/'..(data.username_ or 'sasa_boody')..')'
status  = '\n 🧞‍♂️ تم تنزيله من المميزين'
send(msg.chat_id_, msg.id_, usertext..status)
else
usertext = '\n 🧞‍♂️ العضو ← '..userid..''
...
tdcli_function ({ID = "GetUser",user_id_ = result.sender_user_id_},function(arg,data) 
usertext = '\n 🧞‍♂️ العضــو ← ['..data.first_name_..'](t.me/'..(data.username_ or 'sasa_boody')..')'
...
if blakrt == 'مميز' and Mod(msg) then
send(msg.chat_id_, msg.id_,'\n 🧞‍♂️ العضو ← ['..result.title_..'](t.me/'..(text1[3] or 'sasa_boody')..')'..'\n 🧞‍♂️ تم رفعه '..text1[2]..'')   
database:sadd(bot_id..'Special:User'..msg.chat_id_,result.id_)  
...
if num > 30000 then 
send(msg.chat_id_, msg.id_,'🧞‍♂️تستطيع التنظيف 30000 رساله كحد اقصى') 
return false  
end  
local msgm = msg.id_
for i=1,tonumber(num) do
...
local msg_id = msg.id_/2097152/0.5 
https.request("https://api.telegram.org/bot"..token..'/sendvideo?chat_id=' .. msg.chat_id_ .. '&video=https://t.me/bhhggjhjg/'..ght..'&caption=' .. URL.escape(Text).."&reply_to_message_id="..msg_id.."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard)) 
end
...
local msg_id = msg.id_/2097152/0.5
https.request("https://api.telegram.org/bot"..token..'/sendvideo?chat_id=' .. msg.chat_id_ .. '&video=https://t.me/sasa_boody/131&caption=' .. URL.escape(Text).."&reply_to_message_id="..msg_id.."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard)) 
end
if text == "كلمني" then
...
send(msg.chat_id_, msg.id_,'🧞‍♂️نت حقير معندكش لقب 😹 ') 
else
...
database:set(bot_id.."sasa_boody:insta_bot"..msg.chat_id_,"close")
end
if text == "تفعيل الانستا" and Manager(msg) then
send(msg.chat_id_, msg.id_,' تم تفعيل الانستا')
database:set(bot_id.."sasa_boody:insta_bot"..msg.chat_id_,"open")
end
if text and text:match("^معلومات (.*)$") and database:get(bot_id.."sasa_boody:insta_bot"..msg.chat_id_) == "open" then
local Textni = text:match("^معلومات (.*)$")
data,res = https.request('https://forhassan.ml/hogan/insta.php?username='..URL.escape(Textni)..'')
if res == 200 then
...
database:set(bot_id.."sasa_boody:Tag:Admins:"..msg.chat_id_,true)
send(msg.chat_id_, msg.id_,"🧞‍♂️تم تفعيل تاك المشرفين")
end
if text and text == "تعطيل تاك المشرفين" and Manager(msg) then 
database:del(bot_id.."sasa_boody:Tag:Admins:"..msg.chat_id_)
...
if database:get(bot_id.."sasa_boody:Tag:Admins:"..msg.chat_id_) then 
tdcli_function ({ID = "GetChannelMembers",channel_id_ = msg.chat_id_:gsub("-100",""),filter_ = {ID = "ChannelMembersAdministrators"},offset_ = 0,limit_ = 100},function(arg,data)
...
end --الكود حصري سورس هوجان يعني لو بكتهن راح اعرفك انت الاخذتهن
...
-------------------------------
if text == ""..(database:get(bot_id..'Name:Bot') or 'هوجان').." غادر" or text == 'غادر' then  
...
send(msg.chat_id_,msg.id_, '[انت مطوري نور عنيا🥺🤍](t.me/sasa_boody)') 
return false
end

if text == 'انا مين' and DevSoFi(msg) then 
send(msg.chat_id_,msg.id_, '[انت مطوري الثاني حته مني 😍💚](t.me/sasa_boody)') 
return false
end

if text == 'انا مين' and Sudo(msg) then 
send(msg.chat_id_,msg.id_, '[انت المطور بس الصغنن 🌝💘](t.me/sasa_boody)') 
return false
end

if text == 'انا مين' and CoSu(msg) then 
send(msg.chat_id_,msg.id_, '[نت المالك هن يعني حاجه فوق فوق راسي 😂♥](t.me/sasa_boody)') 
return false
end

if text == 'انا مين' and Constructor(msg) then 
send(msg.chat_id_,msg.id_, '[انت منشئ يسطا عتلاء منشئ عاوز حاجه تانيه😹🤦‍♂️](t.me/sasa_boody)') 
return false
end

if text == 'انا مين' and BasicConstructor(msg) then 
send(msg.chat_id_,msg.id_, '[ انت هنا منشئ اساسي يعني اعلى رتبه عاوزك تفتخر😂🎯](t.me/sasa_boody)') 
return false
end

if text == 'انا مين' and Manager(msg) then 
send(msg.chat_id_,msg.id_, '[ انت المدير يعني الروم تحت سيطرتك😹](t.me/sasa_boody)') 
return false
end

if text == 'انا مين' and Mod(msg) then 
send(msg.chat_id_,msg.id_, '[انت مجرد ادمن اجتهد عشان ياخد رتبه😹 ](t.me/sasa_boody)') 
return false
end

if text == 'انا مين' and Special(msg) then 
send(msg.chat_id_,msg.id_, '[ انت مميز ابن ناس 😊 ](t.me/sasa_boody)') 
return false
end

if text == 'انا مين' then
send(msg.chat_id_,msg.id_, '[انت مجرد عضو زليل حقير ملوش لزمه 😂](t.me/sasa_boody)') 
return false
end
...
for k,v in pairs(list) do
if string.find(text,v) ~= nil then
send(msg.chat_id_,msg.id_, '[نزل عينك عيب كده..🌚♥️](t.me/sasa_boody)') 
return false
end
end
end
...
print("it is Bot")
N = (database:get(bot_id.."Name:Bot") or "هوجان")
...
local Namebot = (database:get(bot_id..'Name:Bot') or 'هوجان') 
local DRAGON_Msg = { 
...
tdcli_function ({ID = "GetUser",user_id_ = result.sender_user_id_},function(extra,data) 
local rtp = Rutba(result.sender_user_id_,msg.chat_id_)
local username = ' ['..data.first_name_..'](t.me/'..(data.username_ or 'sasa_boody')..')'
local iduser = result.sender_user_id_
...
{
{text = ' 🇪🇬𝚂𝙾𝚄𝚁𝙲𝙴 𝑯𝑶𝑮𝑨𝑵 🇪🇬', url="t.me/sasa_boody"},
},
}
local msg_id = msg.id_/2097152/0.5
https.request("https://api.telegram.org/bot"..token..'/sendMessage?chat_id=' .. msg.chat_id_ .. '&text=' .. URL.escape(Text).."&reply_to_message_id="..msg_id.."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard))
...
send(msg.chat_id_, msg.id_, '🧞‍♂️ تم تعطيل الاله حاسبه')
...
send(msg.chat_id_, msg.id_,'🧞‍♂️ تم تفعيل الاله حاسبه')
...
data,res = https.request('https://forhassan.ml/hogan/movie.php?serch='..URL.escape(Textm)..'')
if res == 200 then
...
local Name_Bot = (database:get(bot_id..'Name:Bot') or 'هوجان')
