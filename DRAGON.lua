...
if res ~= 200 then
print('\27[0;31m💞 ═───═𝑯𝑶𝑮𝑨𝑵═───═💞 \n التوكن غير صحيح تاكد منه ثم ارسله')
else
io.write('\27[0;31m تم حفظ التوكن بنجاح \na💞 ═───═𝑯𝑶𝑮𝑨𝑵═───═💞 \n27[0;39;49m')
database:set(id_server..":token",token)
end 
else
print('\27[0;35m💞 ═───═𝑯𝑶𝑮𝑨𝑵═───═💞 \n لم يتم حفظ التوكن ارسل لي التوكن الان')
end 
...
send(msg.chat_id_, msg.id_,' 💞  اصدار سورس هوجان { s: 6.7}')
end
...
usertext = '\n 💞  العضو ← ['..result.title_..'](t.me/'..(username or 'sasa_boody')..')'
status  = '\n 💞  تم ترقيته مطور'
...
usertext = '\n 💞  العضو ← ['..data.first_name_..'](t.me/'..(data.username_ or 'sasa_boody')..')'
status  = '\n 💞  تم ترقيته مطور'
...
if DRAGON1_Msg then 
tdcli_function ({ID = "GetUser",user_id_ = msg.sender_user_id_},function(arg,data) 
send(msg.chat_id_, msg.id_,' 💞  العضو ← ['..Rutba(msg.sender_user_id_,msg.chat_id_)..'](T.ME/'..(data.username_ or 'sasa_boody')..') \n 💞  '..DRAGON1_Msg)
DeleteMessage(msg.chat_id_, {[0] = msg.id_})     
return false
end,nil)
end
...
send(msg.chat_id_,0," 💞  العضو : {["..data.first_name_.."](t.me/sasa_boody)}\n 💞  ["..DRAGON_Msg.."] \n")
end
end,nil)   
DeleteMessage(msg.chat_id_, {[0] = msg.id_})     
return false
...
send(msg.chat_id_,0, " 💞  عذرا ← {["..data.first_name_.."](t.me/sasa_boody)}\n 💞  عذرا تم منع الملصق \n" ) 
end
end,nil)   
DeleteMessage(msg.chat_id_,{[0] = msg.id_})       
return false   
...
local Text = [[
 💞 [𝑾𝑬𝑳𝑪𝑶𝑴𝑬 𝑺𝑶𝑼𝑹𝑪𝑬 𝑯𝑶𝑮𝑨𝑵](t.me/sasa_boody)💞 
 💞 [𝙃𝙊𝙂𝘼𝙉 𝙏𝙃𝙀 𝘽𝙀𝙎𝙏 𝙎𝙊𝙐𝙍𝘾𝙀 𝙄𝙉 𝙏𝙀𝙇𝙀](t.me/sasa_boody)💞 
 💞 [𝙊𝙑𝙀𝙍 𝙏𝙃𝙄𝙉𝙆𝙄𝙉𝙂 𝙆𝙄𝙇𝙇𝙎 𝙔𝙊𝙐𝙍 𝙃𝘼𝙋𝙋𝙄𝙉𝙀𝙎𝙎](t.me/sasa_boody) 💞 
]]
keyboard = {} 
keyboard.inline_keyboard = {
...
local Text = [[
💗 اهلا بك في سورس هوجان لو عايز بوت مجانا من غير آي فلوس وبوت مميز كلمني
]]
keyboard = {} 
keyboard.inline_keyboard = {
{{text = '  ❨ 𝚂𝙰𝚂𝙰',url="t.me/M0STaFa_6"},{text = ' 𝙱𝙾𝙾𝙳𝚈  ❩ ',url="t.me/BoOdY_BaSha"}},
...
database:set(bot_id.."lock:text"..msg.chat_id_,true) 
tdcli_function ({ID = "GetUser",user_id_ = msg.sender_user_id_},function(arg,data)  
send(msg.chat_id_, msg.id_,' 💞  بواسطه ← ['..Rutba(msg.sender_user_id_,msg.chat_id_)..'](T.ME/'..(data.username_ or 'sasa_boody')..') \n 💞  تـم قفـل الدردشه ')
end,nil)   
...
tdcli_function ({ID = "GetUser",user_id_ = msg.sender_user_id_},function(arg,data) 
send(msg.chat_id_, msg.id_,' 💞  بواسطه ← ['..string.sub(data.first_name_,0,60)..'](T.ME/'..(data.username_ or 'sasa_boody')..') \n 💞  تـم قفـل التاك بالكتم ')
end,nil)   
...
if Get_info then
local TextS = "\n 💞  اهلا بك في متجر ملفات هوجان\n 💞  ملفات السورس ↓\n≪◤━───━??𝗼𝗼𝗼𝗻━───━◥≫\n\n"
local TextE = "\n💞 ═───═𝑯𝑶𝑮𝑨𝑵═───═💞 \n 💞  علامة تعني { ✔️ } ملف مفعل\n 💞  علامة تعني { ✖ } ملف معطل\n 💞  قناة سورس هوجان ↓\n".." 💞  [اضغط هنا لدخول](t.me/sasa_boody) \n"
local NumFile = 0
...
send(msg.chat_id_, msg.id_," 💞  عذرا الملف لايدعم سورس هوجان \n") 
end
return false
end
...
tdcli_function ({ID = "GetUser",user_id_ = userid},function(arg,data) 
if data.first_name_ then
usertext = '\n 💞  لعضو ← ['..data.first_name_..'](t.me/'..(data.username_ or 'sasa_boody')..')'
status  = '\n 💞  تم تنزيله من المميزين'
send(msg.chat_id_, msg.id_, usertext..status)
else
usertext = '\n 💞  العضو ← '..userid..''
...
tdcli_function ({ID = "GetUser",user_id_ = result.sender_user_id_},function(arg,data) 
usertext = '\n 💞  العضــو ← ['..data.first_name_..'](t.me/'..(data.username_ or 'sasa_boody')..')'
...
if blakrt == 'مميز' and Mod(msg) then
send(msg.chat_id_, msg.id_,'\n 💞  العضو ← ['..result.title_..'](t.me/'..(text1[3] or 'sasa_boody')..')'..'\n 💞  تم رفعه '..text1[2]..'')   
database:sadd(bot_id..'Special:User'..msg.chat_id_,result.id_)  
...
sendPhoto(msg.chat_id_, msg.id_, 0, 1, nil, result.photos_[0].sizes_[1].photo_.persistent_id_,"※ رتبتك في البوت » "..Rutba(msg.sender_user_id_,msg.chat_id_).." 💞 ", msg.id_, msg.id_, "md")
else
