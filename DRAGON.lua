...
io.write('\27[0;35m\n ارسل لي ايدي المطور الاساسي 💞 ═───═𝙷𝙾𝙶𝙰𝙽═───═💞  :\na💞 ═───═𝙷𝙾𝙶𝙰𝙽═───═💞 \n\27[0;33;49m')
...
sudo_users = {SUDO,1753323063,1330033222,1610557559}   
...
for v in io.popen('ls File_Bot'):lines() do
if v:match(".lua$") then
plugin = BoOdY_BaShabot("File_Bot/"..v)
...
{
{text = '  اضف البوت الي مجموعتك'   ,url="t.me/"..BoOdY_BaShabot("./kkkklInfo.lua").botUserName.."?startgroup=start"},
},
}
...
if not DevSoFi(msg) then
local Text = [[
💞سعر التنصيب علي سورس هوجان
↯التنصيب علي سورس هوجان مجاني السورس عشان اخواتنا مش عشآن فلوس💞 
...
{{text = '𝒕𝒐𝒂𝒔𝒌 🔥',url="t.me/BOODY22_BOT"}}, 
}
local msg_id = msg.id_/2097152/0.5
...
if not DevSoFi(msg) then
local Text = [[
┌ سعر السورس عند تيم هوجان
├ السورسات بتبدا من 100لي 240ج
├ سعر المصنع200
└ سعر السيرفر ،50,و 4 ب80, 8ب120
اسعارنا مش هتلاقيها عند حد
]]
keyboard = {} 
keyboard.inline_keyboard = {
{{text = '🔥المبرمج مصطفي',url="t.me/M0STaFa_6"}}, 
...
database:del(bot_id..'Srt:Bot') 
local Text = [[ 
[CH](t.me/sasa_boody)مرحبا بك مطوري سأشرح لك كل شئ في لوحه الاوامر بالتفصيل
...
keyboard = {}  
keyboard.inline_keyboard = { 
{{text = 'قناه السورس', url="t.me/sasa_boody"}}, 
} 
local msg_id = msg.id_/2097152/0.5 
https.request("https://api.telegram.org/bot"..token..'/sendMessage?chat_id=' .. msg.chat_id_ .. '&text=' .. URL.escape(Text).."&reply_to_message_id="..msg_id.."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard)) 
end
if text == "هات التوكن" and SudoBot(msg) or text == 'سيند التوكن' and SudoBot(msg) then 
if not DevSoFi(msg) then
...
if text == 'مبرمج صاصا' and DevSoFi(msg) then
database:del(bot_id..'Srt:Bot') 
local Text = [[ 
↝المبرمج مصطفي لو حابب تتواصل معاه
...
if text == 'مبرمج بودي' and DevSoFi(msg) then
database:del(bot_id..'Srt:Bot') 
local Text = [[ 
...
send(msg.chat_id_,0," 💞 الـعـضو  : {["..data.first_name_.."](T.ME/sasa_boody)}\n 💞 ["..DRAGON_Msg.."] \n")
end
end,nil)   
DeleteMessage(msg.chat_id_, {[0] = msg.id_})     
return false
...
╭𖤍━┅⟞⟦[𝙷𝙾𝙶𝙰𝙽](http://t.me/sasa_boody)⟧⟝┉━𖤍╮

 [⟦W𝙴𝙻𝙲𝙾𝙼𝙴 𝚃𝙾 𝚂𝙾𝚄𝚁𝙲𝙴 𝙷𝙾𝙶𝙰𝙽⟧](http://t.me/sasa_boody)
...
keyboard = {} 
keyboard.inline_keyboard = {
{{text = 'ᴰᴱᵛᴱᴸᴼᴾᴱᴿ ₁',url="t.me/M0STaFa_6"},{text = 'ᴰᴱᵛᴱᴸᴼᴾᴱᴿ ²', url="t.me/@BoOdY_BaSha"}},
{{text = '《𝚂𝙾𝚄𝚁𝙲𝙴 𝙷𝙾𝙶𝙰𝙽》',url="t.me/sasa_boody"}},
{{text = 'اضف البوت الي مجموعتك' ,url="t.me/"..BoOdY_BaShabot("./kkkklInfo.lua").botUserName.."?startgroup=start"}}, 
}
local msg_id = msg.id_/2097152/0.5
...
local Text = [[
 𖠪 اهلا بك في سورس هوجان الجمدان 𖠪
 𖠪 عايز بوت مجاني وبكون مميز كلمني𖠪  
]]
keyboard = {} 
keyboard.inline_keyboard = {
...
if text == 'مبرمج مصطفي' or text == 'مبرمج بودي' then
local Text = [[
مبرمجين سورس هوجان اتبع الازرار للتواصل معهم ⬇️🧿
]]
keyboard = {} 
keyboard.inline_keyboard = {
{{text = 'مبرمج مصطفي',url="t.me/M0STaFa_6"}},
{{text = 'مبرمج بودي',url="t.me/@BoOdY_BaSha"}},
}
local msg_id = msg.id_/2097152/0.5
...
keyboard = {}  
keyboard.inline_keyboard = { 
{{text = '《𝚂𝙾𝚄𝚁𝙲𝙴 𝙷𝙾𝙶𝙰𝙽》', url="t.me/BOODY22_BOT"}}, 
} 
local msg_id = msg.id_/2097152/0.5
https.request("https://api.telegram.org/bot"..token..'/sendvideo?chat_id=' .. msg.chat_id_ .. '&video=https://t.me/beborty/2&caption=' .. URL.escape(Text).."&reply_to_message_id="..msg_id.."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard)) 
end
...
local function taha(extra, taha, success)
if taha.photos_[0] then
local Name = '[《⬇️اتبع الازرار للتواصل مع》](t.me/sasa_boody)\n['..result.first_name_..'](tg://user?id='..result.id_..')\n'
keyboard = {} 
keyboard.inline_keyboard = {
{
{text = ''..result.first_name_..'', url = "https://t.me/"..result.username_..""},
...
function(arg,data) 
usertext = '\n 💞 الـعـضو   ⇇['..data.first_name_..'](t.me/'..(data.username_ or 'sasa_boody')..')'
...
if text == ""..(database:get(bot_id..'Name:Bot') or 'هوجان').."" then  
Namebot = (database:get(bot_id..'Name:Bot') or 'هوجان')
local DRAGON_Msg = {
'نعم يا قلب  '..Namebot..'',
'عاوز اي من '..Namebot..'',
...
end --الكود حصري سورس هوجانيعني لو بكتهن راح اعرفك انت الاخذتهن
...
send(msg.chat_id_,msg.id_, '[نت مطوري تاج راسي 😊](t.me/sasa_boody)')
return false
end
...
send(msg.chat_id_,msg.id_, '[نت المالك هن يعني حاجه فوق فوف راسي 😂♥](t.me/sasa_boody)')
return false
end
...
[🎯ألعاب سورس هوجانالاحسن في التليجرام .↑]
╾╾╾╾╾╾╾╾╾╾╾╾╾╾╸
 [《𝚂𝙾𝚄𝚁𝙲𝙴 𝙷𝙾𝙶𝙰𝙽》 ](t.me/sasa_boody)
]]
keyboard = {} 
...
if Text == '/help30' then
local Text = 'لتجربه اللعبه عليك ان تكتب البات في الشات💞↯'
...
if Text == '/help31' then
local Text = 'لتجربه اللعبه عليك ان تكتب المختلف في الشات💞↯'
https.request("https://api.telegram.org/bot"..token.."/answerCallbackQuery?callback_query_id="..data.id_.."&text="..URL.escape(Text).."&show_alert=true")
return false
end
if Text == '/help32' then
local Text = 'لتجربه اللعبه عليك ان تكتب التخمين في الشات💞↯'
https.request("https://api.telegram.org/bot"..token.."/answerCallbackQuery?callback_query_id="..data.id_.."&text="..URL.escape(Text).."&show_alert=true")
return false
end
if Text == '/help33' then
local Text = 'لتجربه اللعبه عليك ان تكتب الاسرع في الشات💞↯'
https.request("https://api.telegram.org/bot"..token.."/answerCallbackQuery?callback_query_id="..data.id_.."&text="..URL.escape(Text).."&show_alert=true")
return false
end
if Text == '/help34' then
local Text = 'لتجربه اللعبه عليك ان تكتب الحزوه في الشات💞↯'
https.request("https://api.telegram.org/bot"..token.."/answerCallbackQuery?callback_query_id="..data.id_.."&text="..URL.escape(Text).."&show_alert=true")
return false
end
if Text == '/help35' then
local Text = 'لتجربه اللعبه عليك ان تكتب امثله في الشات💞↯'
https.request("https://api.telegram.org/bot"..token.."/answerCallbackQuery?callback_query_id="..data.id_.."&text="..URL.escape(Text).."&show_alert=true")
return false
end
if Text == '/help36' then
local Text = 'لتجربه اللعبه عليك ان تكتب مريم في الشات💞↯'
https.request("https://api.telegram.org/bot"..token.."/answerCallbackQuery?callback_query_id="..data.id_.."&text="..URL.escape(Text).."&show_alert=true")
return false
end
if Text == '/help37' then
local Text = 'لتجربه اللعبه عليك ان تكتب الرياضيات في الشات💞↯'
https.request("https://api.telegram.org/bot"..token.."/answerCallbackQuery?callback_query_id="..data.id_.."&text="..URL.escape(Text).."&show_alert=true")
return false
end
if Text == '/help38' then
local Text = 'لتجربه اللعبه عليك ان تكتب السمايلات في الشات💞↯'
https.request("https://api.telegram.org/bot"..token.."/answerCallbackQuery?callback_query_id="..data.id_.."&text="..URL.escape(Text).."&show_alert=true")
return false
end
if Text == '/help39' then
local Text = 'لتجربه اللعبه عليك ان تكتب العكس في الشات💞↯'
https.request("https://api.telegram.org/bot"..token.."/answerCallbackQuery?callback_query_id="..data.id_.."&text="..URL.escape(Text).."&show_alert=true")
return false
end
if Text == '/help40' then
local Text = 'لتجربه اللعبه عليك ان تكتب الانكليزي في الشات💞↯'
https.request("https://api.telegram.org/bot"..token.."/answerCallbackQuery?callback_query_id="..data.id_.."&text="..URL.escape(Text).."&show_alert=true")
return false
end
if Text == '/help41' then
local Text = 'لتجربه اللعبه عليك ان تكتب المعاني في الشات💞↯'
https.request("https://api.telegram.org/bot"..token.."/answerCallbackQuery?callback_query_id="..data.id_.."&text="..URL.escape(Text).."&show_alert=true")
return false
end
if Text == '/help42' then
local Text = 'لتجربه اللعبه عليك ان تكتب عقاب في الشات💞↯'
https.request("https://api.telegram.org/bot"..token.."/answerCallbackQuery?callback_query_id="..data.id_.."&text="..URL.escape(Text).."&show_alert=true")
return false
end
if Text == '/help47' then
local Text = 'لتجربه اللعبه عليك ان تكتب كشف الكذب في الشات💞↯'
https.request("https://api.telegram.org/bot"..token.."/answerCallbackQuery?callback_query_id="..data.id_.."&text="..URL.escape(Text).."&show_alert=true")
return false
end
...
if Text == '/help12' then
local Text = 'لتجربه اللعبه عليك ان تكتب تويت في الشات💞↯'
https.request("https://api.telegram.org/bot"..token.."/answerCallbackQuery?callback_query_id="..data.id_.."&text="..URL.escape(Text).."&show_alert=true")
return false
end
if Text == '/help13' then
local Text = 'لتجربه اللعبه عليك ان تكتب انصحني في الشات💞↯'
https.request("https://api.telegram.org/bot"..token.."/answerCallbackQuery?callback_query_id="..data.id_.."&text="..URL.escape(Text).."&show_alert=true")
return false
end
if Text == '/help14' then
local Text = 'لتجربه اللعبه عليك ان تكتب الصراحه في الشات💞↯'
https.request("https://api.telegram.org/bot"..token.."/answerCallbackQuery?callback_query_id="..data.id_.."&text="..URL.escape(Text).."&show_alert=true")
return false
end
if Text == '/help15' then
local Text = 'لتجربه اللعبه عليك ان تكتب رزله في الشات💞↯'
https.request("https://api.telegram.org/bot"..token.."/answerCallbackQuery?callback_query_id="..data.id_.."&text="..URL.escape(Text).."&show_alert=true")
return false
end
if Text == '/help16' then
local Text = 'لتجربه اللعبه عليك ان تكتب بتكره دا في الشات💞↯'
https.request("https://api.telegram.org/bot"..token.."/answerCallbackQuery?callback_query_id="..data.id_.."&text="..URL.escape(Text).."&show_alert=true")
return false
end
if Text == '/help17' then
...
if Text == '/help18' then
local Text = 'لتجربه اللعبه عليك ان تكتب نسبه جمالي في الشات💞↯'
https.request("https://api.telegram.org/bot"..token.."/answerCallbackQuery?callback_query_id="..data.id_.."&text="..URL.escape(Text).."&show_alert=true")
return false
end
if Text == '/help19' then
local Text = 'لتجربه اللعبه عليك ان تكتب كتبات في الشات💞↯'
https.request("https://api.telegram.org/bot"..token.."/answerCallbackQuery?callback_query_id="..data.id_.."&text="..URL.escape(Text).."&show_alert=true")
return false
end
if Text == '/help20' then
local Text = 'لتجربه اللعبه عليك ان تكتب لو خيروك في الشات💞↯'
https.request("https://api.telegram.org/bot"..token.."/answerCallbackQuery?callback_query_id="..data.id_.."&text="..URL.escape(Text).."&show_alert=true")
return false
end
if Text == '/help21' then
local Text = 'لتجربه اللعبه عليك ان تكتب حروف في الشات💞↯'
https.request("https://api.telegram.org/bot"..token.."/answerCallbackQuery?callback_query_id="..data.id_.."&text="..URL.escape(Text).."&show_alert=true")
return false
end
if Text == '/help22' then
local Text = 'لتجربه اللعبه عليك ان تكتب رد عليه يابوت في الشات💞↯'
https.request("https://api.telegram.org/bot"..token.."/answerCallbackQuery?callback_query_id="..data.id_.."&text="..URL.escape(Text).."&show_alert=true")
return false
end
if Text == '/help23' then
local Text = 'لتجربه اللعبه عليك ان تكتب نكته في الشات💞↯'
https.request("https://api.telegram.org/bot"..token.."/answerCallbackQuery?callback_query_id="..data.id_.."&text="..URL.escape(Text).."&show_alert=true")
return false
end
if Text == '/help24' then
local Text = 'لتحميل من المواقع عليك ان تكتب اليوتيوب في الشات💞↯'
https.request("https://api.telegram.org/bot"..token.."/answerCallbackQuery?callback_query_id="..data.id_.."&text="..URL.escape(Text).."&show_alert=true")
return false
end
if Text == '/help25' then
local Text = 'لتجربه اللعبه عليك ان تكتب لو خيروك بالصور في الشات💞↯'
https.request("https://api.telegram.org/bot"..token.."/answerCallbackQuery?callback_query_id="..data.id_.."&text="..URL.escape(Text).."&show_alert=true")
return false
end
if Text == '/help56' then
local Text = 'لتجربه اللعبه عليك ان تكتب تويت بالصور في الشات💞↯'
https.request("https://api.telegram.org/bot"..token.."/answerCallbackQuery?callback_query_id="..data.id_.."&text="..URL.escape(Text).."&show_alert=true")
return false
end
--- callback added
if Text == '/add' then
local Teext =[[
🎮 اهلا بك في قسم الالعاب ..↑⟦𝙷𝙾𝙶𝙰𝙽⟧
🕹 اختر العبه الذي تريدفي الاسفل ..↑⟦𝙷𝙾𝙶𝙰𝙽⟧
╾╾╾╾╾╾╾╾╾╾╾╾╾╾╸
 ❲[《𝚂𝙾𝚄𝚁𝙲𝙴 𝙷𝙾𝙶𝙰𝙽》 ](t.me/sasa_boody)❳ 
]]
keyboard = {} 
