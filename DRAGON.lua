...
{' مبرمج بودي','مبرمج مصطفي','مبرمج جوكر'},
...
{{text = '  ❨  𝐉𝐎𝐊𝐄𝐑 𝐑𝐀𝐏  ❩ ',url="t.me/jokerrap2"}}, 
...
if text == 'جوكر' or text == 'جوكر راب' or text == 'جوكر عبدالله' or text == 'مبرمج جوكر' or text == 'جوكر فين' or text == 'جوكر راب فين' then 
local msg_id = msg.id_/2097152/0.5  
local Text = [[ 
  𝐉𝐎𝐊𝐄𝐑 𝐑𝐀𝐏
]] 
keyboard = {}  
keyboard.inline_keyboard = { 
{{text = '  𝐉𝐎𝐊𝐄𝐑 𝐑𝐀𝐏',url="t.me/M0STaFa_6"}}, 
} 
...
local msg_id = msg.id_/2097152/0.5  
local textt = '[انت مطوري الثاني حته مني بس م هينفع اعرصلك 😍💚](t.me/sasa_boody)'
keyboard = {} 
keyboard.inline_keyboard = {
{
{text = 'الـمـطـور', url="http://t.me/"..sudos.UserName},
...
local msg_id = msg.id_/2097152/0.5  
local textt = '[نت المالك الجامد ال هنا 😂♥](t.me/sasa_boody)'
keyboard = {} 
keyboard.inline_keyboard = {
{
{text = 'الـمـطـور', url="http://t.me/"..sudos.UserName},
...
local msg_id = msg.id_/2097152/0.5  
local textt = '[انت منشئ الشب الجامد🤦‍♂️](t.me/sasa_boody)'
keyboard = {} 
keyboard.inline_keyboard = {
{
{text = 'الـمـطـور', url="http://t.me/"..sudos.UserName},
...
local msg_id = msg.id_/2097152/0.5  
local textt = '[ انت هنا منشئ اساسي رتبه لسه صغنون😂🎯](t.me/sasa_boody)'
keyboard = {} 
keyboard.inline_keyboard = {
{
{text = 'الـمـطـور', url="http://t.me/"..sudos.UserName},
...
local msg_id = msg.id_/2097152/0.5  
local textt = '[ انت المدير المسيطر ع روم😹](t.me/sasa_boody)'
keyboard = {} 
keyboard.inline_keyboard = {
{
{text = 'الـمـطـور', url="http://t.me/"..sudos.UserName},
...
local msg_id = msg.id_/2097152/0.5  
local textt = '[انت مجرد ادمن خليك جمد وخد رتبه احسن😹 ](t.me/sasa_boody)'
keyboard = {} 
keyboard.inline_keyboard = {
{
{text = 'الـمـطـور', url="http://t.me/"..sudos.UserName},
...
local msg_id = msg.id_/2097152/0.5  
local textt = '[ انت مميز حاجه صغيره 😊 ](t.me/sasa_boody)'
keyboard = {} 
keyboard.inline_keyboard = {
{
{text = 'الـمـطـور', url="http://t.me/"..sudos.UserName},
...
local msg_id = msg.id_/2097152/0.5  
local textt = '[ انت مجرد عضو ملكش لازمه 🌝💘 ](t.me/sasa_boody)'
keyboard = {} 
keyboard.inline_keyboard = {
{
{text = 'الـمـطـور', url="http://t.me/"..sudos.UserName},
